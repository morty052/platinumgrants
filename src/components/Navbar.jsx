  ...
  <nav className="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
    ...
    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
      <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
        ...
        {/* MAIN LINKS */}
        <NavLink to={'/'} data-hs-collapse="#navbar-collapse-with-animation" className="font-medium text-white sm:py-6 hs-collapse-toggle "  aria-current="page">Home</NavLink>
        <NavLink to={"/aboutus"} data-hs-collapse="#navbar-collapse-with-animation" className="font-medium text-white/[.8] hover:text-white sm:py-6 hs-collapse-toggle " href="#">About Us</NavLink>
        ...
        <div className="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] sm:[--trigger:hover] sm:py-4">
         { !path.includes('/application')  &&
          ...
          <button type="button" data-hs-collapse="#navbar-collapse-with-animation" className="hs-collapse-toggle flex items-center sm:w-full bg-white py-2 px-4 rounded-md text-blue-600 hover:text-blue-700 ring hover:ring-blue-200 font-medium transition-all duration-100 ease-linear">
            Apply
          ...
          {/* {Login Button} */}
        <NavLink to={"/login"} data-hs-collapse="#navbar-collapse-with-animation"  className="flex hs-collapse-toggle  items-center gap-x-2 font-medium text-white/[.8] hover:text-white sm:border-l sm:border-white/[.3] sm:my-6 sm:pl-6" >
