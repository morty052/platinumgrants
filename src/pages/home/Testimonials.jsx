  ...
  <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
      <h2 class="text-2xl sm:text-3xl lg:text-4xl text-white font-semibold">
        Few words from Approved Applicants.
      </h2>
    </div>
    {/* <!-- End Title --> */}
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="flex h-auto">
        <div class="flex flex-col bg-white rounded-xl ">
          <div class="flex-auto p-4 md:p-6">
            <p class="text-base italic md:text-lg text-gray-800 ">
              " After a whole year struggling to pay rent as a single mom. Getting a housing grant transformed my life  "
            </p>
          </div>
    ...
    <div class="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
      {/* <!-- Stats --> */}
      <div>
        <h4 class="text-lg sm:text-xl font-semibold text-white">Approval rate</h4>
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">67.15%</p>
        <p class="mt-1 text-gray-400">after 2000+ submissions</p>
      </div>
      {/* <!-- End Stats --> */}

      {/* <!-- Stats --> */}
      <div>
        <h4 class="text-lg sm:text-xl font-semibold text-white">Over</h4>
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">$19.7M+</p>
        <p class="mt-1 text-gray-400">In grants since 2021</p>
      </div>
      {/* <!-- End Stats --> */}

      {/* <!-- Stats --> */}
      <div>
        <h4 class="text-lg sm:text-xl font-semibold text-white">Approved</h4>
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-blue-500">200+</p>
        <p class="mt-1 text-gray-400">Grants this year alone</p>
      </div>
      {/* <!-- End Stats --> */}
    </div>
    {/* <!-- End Grid --> */}
