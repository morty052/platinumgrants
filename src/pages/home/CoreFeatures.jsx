  ...
  <div class="grid md:grid-cols-2 gap-12">
    <div class="lg:w-3/4">
      ...
      <NavLink to={'/application'} className="mt-5 cursor-pointer group inline-flex items-center gap-x-2 font-medium text-blue-600 ">
        Submit application.
        <svg class="w-2.5 h-2.5 transition ease-in-out group-hover:translate-x-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="space-y-6 lg:space-y-10">
      ...
      <div class="flex">
        ...
        <div class="ml-5 sm:ml-8">
          ...
          These Grants are not a loan and you don’t need to pay back as long as you qualify for the grant you choose.
          </p>
        </div>
      </div>
      {/* <!-- End Icon Block --> */}
      ...
      <div class="flex">
        ...
        <div class="ml-5 sm:ml-8">
          ...
          <p class="mt-1 text-gray-600 ">
            We always ensure to get applications from submitted to approved status as soon as possible.
          </p>
        </div>
      </div>
      {/* <!-- End Icon Block --> */}
      ...
      <div class="flex">
        ...
        <div class="ml-5 sm:ml-8">
          ...
          <p class="mt-1 text-gray-600 ">
            Rejected applicants get detailed feedback on how to improve their next application insightfully.
          </p>
        </div>
      </div>
      {/* <!-- End Icon Block --> */}
