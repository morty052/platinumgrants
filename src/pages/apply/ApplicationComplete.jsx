    ...
    <div className="min-h-screen bg-[#38bdf8]    ">
      <div className="container mx-auto py-10 max-w-xl ">
        ...
        <p className=" text-center text-gray-50">
          Keep an eye on your email {applicant?.email}, for updates on your
          aplication from admin@Northwestgrants.com. you can also track your
          application by signing in using the email on your application.{" "}
        </p>
        <div className="py-4 flex justify-center">
          <NavLink to={"/login"}>
            <button className=" border border-white px-6 text-white py-2 rounded-2xl">
              Track Application &#8594;
            </button>
          </NavLink>
        </div>
